...
MIGRATION_MODULES = {"sites": "plants_api.contrib.sites.migrations"}
...
#STATIC_ROOT = "plants_api/staticfiles"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "plants_api.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""herbalJavier Oviedo""", "javieroviedo2000@gmail.com")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "plants_api.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "plants_api.users.adapters.SocialAccountAdapter"
